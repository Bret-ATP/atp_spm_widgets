// ===========================================
// Ultimate Objectives Status Widget
// ===========================================
...
id: 'uo_status_color_bar_widget',
name: 'Ultimate Objectives Status',
previewSrc: 'https://raw.githubusercontent.com/Bret-ATP/atp_spm_widgets/main/img/so_status_preview.png',
description: 'Status summary of Ultimate Objectives',
tags: ['OKR', 'Ultimate Objectives'],
...
$widget.append(
$('<h3>').text(props.settings.title || 'Ultimate Objectives Status')
);
...
$.ajax({
url: '/api/v1/UltimateObjectives?include=[Progress]&format=json',
type: 'GET',
dataType: 'json'
...
// ===========================================
// Ultimate Objectives Summary Widget
// ===========================================
...
id: 'ultimate_objectives_summary_progress',
name: 'Ultimate Objectives Summary',
...
description: 'Ultimate Objectives grid with progress and status',
tags: ['OKR', 'Ultimate Objectives'],
placeholder: 'restui_board',
...
$widget.append(
$('<h3>').text(
props.settings.title || 'Ultimate Objectives'
)
);
...
// === INTERACTIVITY: Ultimate Objective card hover/click ===
$card.css({
cursor: 'pointer',
transition: 'all 0.15s ease'
});

$card.attr('title', 'Click to open Ultimate Objective');
...
openEntityModal('ultimateobjective', obj.id, obj.name);
});
// === END INTERACTIVITY ===
...
$.ajax({
url: '/api/v1/UltimateObjectives?include=[Name,Progress]&format=json',
type: 'GET',
dataType: 'json'
}).done(function(response) {
...
// ===========================================
// Ultimate OKR Summary Widget (UNCHANGED WORKING VERSION)
// ===========================================
...
id: 'ultimate_objectives_grid_krs',
name: 'Ultimate OKR Summary',
...
description: 'Ultimate Objectives with Key Results',
tags: ['OKR', 'Ultimate Objectives'],
placeholder: 'restui_board',
...
$.ajax({
url: '/api/v1/UltimateObjectives?include=[Id,Name,Progress,CustomFields]&format=json',
type: 'GET',
dataType: 'json'
}).done(function (response) {
...
$widget.append(
$('<h3>').text(props.settings.title || 'Ultimate Objectives')
);
...
$.ajax({
url: '/api/v1/UltimateObjectives/' + obj.Id + '/KeyResults?include=[Id,Name,Progress,CustomFields]&format=json',
type: 'GET',
dataType: 'json'
