# Ultimate Objectives Widget Pack (Targetprocess)

This pack provides dashboard widgets for ultimate objectives in Targetprocess / Apptio Targetprocess.

## Included Widgets

- **Ultimate Objectives Status** — aggregate progress/status gauge and RAG distribution.
- **Ultimate Objectives Summary** — card grid with objective progress, calculated status, and state.
- **Ultimate OKR Summary** — objective card grid with nested Key Results.

## Key Capabilities

- Uses native **Ultimate Objectives** data from `/api/v1/UltimateObjectives`.
...
- Filter options are discovered from the `Ultimate Objectives` returned by the API.
...
- Filters are synchronized across widgets in the same pack:
  - filtering in **Ultimate Objectives Status** updates **Ultimate Objectives Summary** and **Ultimate OKR Summary**;
  - filtering in **Ultimate Objectives Summary** updates the other widgets;
  - filtering in **Ultimate OKR Summary** updates the other widgets.
